...
public class A_singup {

	public static void main(String[] args) throws InterruptedException, AWTException {
		System.setProperty("webdriver.chrome.driver","C:\\webdriver\\webdriver\\chromedriver-win32\\chromedriver.exe");
		...
		Thread.sleep(2000);
		driver.findElement(By.id("firstname")).sendKeys("marry");
		Thread.sleep(2000);
